...
lyr_SRTMGL1terraindata_0.setVisible(true);lyr_Dark_1.setVisible(true);lyr_Contours_2.setVisible(true);lyr_BoundariesCZK_3.setVisible(true);lyr_BoundariesSVK_4.setVisible(true);lyr_BoundariesPOLWojewodztwa_5.setVisible(true);lyr_Voting_gminy_6.setVisible(true);lyr_Voting_powiaty_7.setVisible(true);lyr_Voting_wojewodztwa_8.setVisible(true);lyr_Population_density_9.setVisible(true);lyr_Data_agregate_log_gis_10.setVisible(true);lyr_generation_agregat_logarithmic_heat_11.setVisible(true);lyr_generation_agregat_heat_12.setVisible(true);lyr_Windpowerplants_13.setVisible(true);lyr_Solarpowerplants_14.setVisible(true);lyr_Oilgaspowerplants_15.setVisible(true);lyr_Nuclearpowerplants_16.setVisible(true);lyr_Hydroelectricpowerplants_17.setVisible(true);lyr_Coalpowerplants_18.setVisible(true);lyr_Coalminesnonoperating_19.setVisible(true);lyr_Coalminesoperating_20.setVisible(true);lyr_Cementconcreteplants_21.setVisible(true);lyr_Bioenergypowerplants_22.setVisible(true);lyr_Boundariespolslaskiesilesian_voivodeship_boundaries_23.setVisible(true);lyr_Grid_24.setVisible(true);
...
lyr_Voting_gminy_6.set('fieldLabels', {'fid': 'no label', 'JPT_KOD_JE': 'no label', 'JPT_NAZWA_': 'no label', 'RODZAJ': 'no label', 'Ele_win': 'no label', '2024-sejmiki-po-gminach-proc_Rodzaj jednostki': 'no label', '2024-sejmiki-po-gminach-proc_Gmina': 'no label', '2024-sejmiki-po-gminach-proc_Powiat': 'no label', '2024-sejmiki-po-gminach-proc_Województwo': 'no label', '2024-sejmiki-po-gminach-proc_KO': 'no label', '2024-sejmiki-po-gminach-proc_PSL': 'no label', '2024-sejmiki-po-gminach-proc_PiS': 'no label', });
lyr_Voting_powiaty_7.set('fieldLabels', {'fid': 'no label', 'JPT_KOD_JE': 'no label', 'JPT_NAZWA_': 'no label', 'RODZAJ': 'no label', 'winner': 'no label', '2024-sejmiki-po-powiatach-proc_Powiat': 'no label', '2024-sejmiki-po-powiatach-proc_Województwo': 'no label', '2024-sejmiki-po-powiatach-proc_KO': 'no label', '2024-sejmiki-po-powiatach-proc_PiS': 'no label', });
