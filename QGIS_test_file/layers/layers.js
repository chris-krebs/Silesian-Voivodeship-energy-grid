...
var lyr_Contours_1 = new ol.layer.Image({
        opacity: 1,
...
var format_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2 = new ol.format.GeoJSON();
var features_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2 = format_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2.readFeatures(json_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2.addFeatures(features_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2);
var lyr_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2, 
                style: style_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2,
                popuplayertitle: 'Global-Wind-Power-Tracker-February-2026_prep_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2.png" /> Global-Wind-Power-Tracker-February-2026_prep_gis_slaskie copy'
            });
var format_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3 = new ol.format.GeoJSON();
var features_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3 = format_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3.readFeatures(json_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3.addFeatures(features_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3);
var lyr_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3, 
                style: style_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3,
                popuplayertitle: 'Global-Solar-Power-Tracker-February-2026_gis_slaskie_only',
                interactive: true,
                title: '<img src="styles/legend/GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3.png" /> Global-Solar-Power-Tracker-February-2026_gis_slaskie_only'
            });
var format_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4 = new ol.format.GeoJSON();
var features_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4 = format_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4.readFeatures(json_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4.addFeatures(features_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4);
var lyr_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4, 
                style: style_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4,
                popuplayertitle: 'Global-Oil-and-Gas-Plant-Tracker-GOGPT-January-2026_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4.png" /> Global-Oil-and-Gas-Plant-Tracker-GOGPT-January-2026_gis_slaskie copy'
            });
var format_GlobalNuclearPowerTrackerSeptember2025_giscopy_5 = new ol.format.GeoJSON();
var features_GlobalNuclearPowerTrackerSeptember2025_giscopy_5 = format_GlobalNuclearPowerTrackerSeptember2025_giscopy_5.readFeatures(json_GlobalNuclearPowerTrackerSeptember2025_giscopy_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalNuclearPowerTrackerSeptember2025_giscopy_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalNuclearPowerTrackerSeptember2025_giscopy_5.addFeatures(features_GlobalNuclearPowerTrackerSeptember2025_giscopy_5);
var lyr_GlobalNuclearPowerTrackerSeptember2025_giscopy_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalNuclearPowerTrackerSeptember2025_giscopy_5, 
                style: style_GlobalNuclearPowerTrackerSeptember2025_giscopy_5,
                popuplayertitle: 'Global-Nuclear-Power-Tracker-September-2025_gis copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalNuclearPowerTrackerSeptember2025_giscopy_5.png" /> Global-Nuclear-Power-Tracker-September-2025_gis copy'
            });
var format_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6 = new ol.format.GeoJSON();
var features_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6 = format_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6.readFeatures(json_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6.addFeatures(features_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6);
var lyr_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6, 
                style: style_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6,
                popuplayertitle: 'Global-Hydropower-Tracker-April-2025_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6.png" /> Global-Hydropower-Tracker-April-2025_gis_slaskie copy'
            });
var format_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7 = new ol.format.GeoJSON();
var features_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7 = format_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7.readFeatures(json_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7.addFeatures(features_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7);
var lyr_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7, 
                style: style_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7,
                popuplayertitle: 'Global-Coal-Plant-Tracker-January-2026_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7.png" /> Global-Coal-Plant-Tracker-January-2026_gis_slaskie copy'
            });
var format_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8 = new ol.format.GeoJSON();
var features_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8 = format_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8.readFeatures(json_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8.addFeatures(features_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8);
var lyr_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8, 
                style: style_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8,
                popuplayertitle: 'Global-Coal-Mine-Tracker-May-2025-V2_non_operating_gis_slaskie_correct',
                interactive: true,
                title: '<img src="styles/legend/GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8.png" /> Global-Coal-Mine-Tracker-May-2025-V2_non_operating_gis_slaskie_correct'
            });
var format_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9 = new ol.format.GeoJSON();
var features_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9 = format_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9.readFeatures(json_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9.addFeatures(features_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9);
var lyr_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9, 
                style: style_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9,
                popuplayertitle: 'Global-Coal-Mine-Tracker-May-2025-V2_operating_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9.png" /> Global-Coal-Mine-Tracker-May-2025-V2_operating_gis_slaskie copy'
            });
var format_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10 = new ol.format.GeoJSON();
var features_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10 = format_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10.readFeatures(json_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10.addFeatures(features_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10);
var lyr_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10, 
                style: style_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10,
                popuplayertitle: 'Global-Cement-and-Concrete-Tracker_July-2025_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10.png" /> Global-Cement-and-Concrete-Tracker_July-2025_gis_slaskie copy'
            });
var format_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11 = new ol.format.GeoJSON();
var features_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11 = format_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11.readFeatures(json_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11.addFeatures(features_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11);
var lyr_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11, 
                style: style_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11,
                popuplayertitle: 'Global-Bioenergy-Power-Tracker-GBPT-V3_gis_slaskie copy',
                interactive: true,
                title: '<img src="styles/legend/GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11.png" /> Global-Bioenergy-Power-Tracker-GBPT-V3_gis_slaskie copy'
            });
var format_Grid_12 = new ol.format.GeoJSON();
var features_Grid_12 = format_Grid_12.readFeatures(json_Grid_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Grid_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Grid_12.addFeatures(features_Grid_12);
var lyr_Grid_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Grid_12, 
                style: style_Grid_12,
                popuplayertitle: 'Grid',
                interactive: true,
                title: '<img src="styles/legend/Grid_12.png" /> Grid'
            });
var group_Bioenergypower = new ol.layer.Group({
                                layers: [lyr_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11,],
                                fold: 'open',
                                title: 'Bioenergy power'});
var group_Cementandconcrete = new ol.layer.Group({
                                layers: [lyr_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10,],
                                fold: 'open',
                                title: 'Cement and concrete'});
var group_Coalmineoperating = new ol.layer.Group({
                                layers: [lyr_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9,],
                                fold: 'open',
                                title: 'Coal mine // operating'});
var group_Coalminenonoperating = new ol.layer.Group({
                                layers: [lyr_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8,],
                                fold: 'open',
                                title: 'Coal mine // non-operating'});
var group_Coalpower = new ol.layer.Group({
                                layers: [lyr_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7,],
                                fold: 'open',
                                title: 'Coal power'});
var group_Hydropower = new ol.layer.Group({
                                layers: [lyr_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6,],
                                fold: 'open',
                                title: 'Hydro power'});
var group_Nuclearpower = new ol.layer.Group({
                                layers: [lyr_GlobalNuclearPowerTrackerSeptember2025_giscopy_5,],
                                fold: 'open',
                                title: 'Nuclear power'});
var group_Oilandgaspower = new ol.layer.Group({
                                layers: [lyr_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4,],
                                fold: 'open',
                                title: 'Oil and gas power'});
var group_Solarpower = new ol.layer.Group({
                                layers: [lyr_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3,],
                                fold: 'open',
                                title: 'Solar power'});
var group_Windpower = new ol.layer.Group({
                                layers: [lyr_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2,],
                                fold: 'open',
                                title: 'Wind power'});

lyr_Dark_0.setVisible(true);lyr_Contours_1.setVisible(true);lyr_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2.setVisible(true);lyr_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3.setVisible(true);lyr_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4.setVisible(true);lyr_GlobalNuclearPowerTrackerSeptember2025_giscopy_5.setVisible(true);lyr_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6.setVisible(true);lyr_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7.setVisible(true);lyr_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8.setVisible(true);lyr_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9.setVisible(true);lyr_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10.setVisible(true);lyr_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11.setVisible(true);lyr_Grid_12.setVisible(true);
var layersList = [lyr_Dark_0,lyr_Contours_1,group_Windpower,group_Solarpower,group_Oilandgaspower,group_Nuclearpower,group_Hydropower,group_Coalpower,group_Coalminenonoperating,group_Coalmineoperating,group_Cementandconcrete,group_Bioenergypower,lyr_Grid_12];
lyr_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2.set('fieldAliases', {'Date Last Researched': 'Date Last Researched', 'Country/Area': 'Country/Area', 'Project Name': 'Project Name', 'Phase Name': 'Phase Name', 'Capacity (MW)': 'Capacity (MW)', 'Installation Type': 'Installation Type', 'Status': 'Status', 'Start year': 'Start year', 'Retired year': 'Retired year', 'Operator': 'Operator', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location accuracy': 'Location accuracy', 'City': 'City', 'Local area (taluk, county)': 'Local area (taluk, county)', 'Major area (prefecture, district)': 'Major area (prefecture, district)', 'State/Province': 'State/Province', 'Subregion': 'Subregion', 'Region': 'Region', 'GEM location ID': 'GEM location ID', 'GEM phase ID': 'GEM phase ID', 'Other IDs (location)': 'Other IDs (location)', 'Other IDs (unit/phase)': 'Other IDs (unit/phase)', 'Wiki URL': 'Wiki URL', });
lyr_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3.set('fieldAliases', {'Longitude': 'Longitude', 'Latitude': 'Latitude', 'Date Last Researched': 'Date Last Researched', 'Country/Area': 'Country/Area', 'Project Name': 'Project Name', 'Capacity (MW)': 'Capacity (MW)', 'Capacity Rating': 'Capacity Rating', 'Technology Type': 'Technology Type', 'Status': 'Status', 'Location accuracy': 'Location accuracy', 'City': 'City', 'Local area (taluk, county)': 'Local area (taluk, county)', 'State/Province': 'State/Province', 'Subregion': 'Subregion', 'Region': 'Region', 'GEM location ID': 'GEM location ID', 'GEM phase ID': 'GEM phase ID', 'Wiki URL': 'Wiki URL', });
lyr_GlobalOilandGasPlantTrackerGOGPTJanuary2026_gis_slaskiecopy_4.set('fieldAliases', {'Wiki URL': 'Wiki URL', 'Country/Area': 'Country/Area', 'Plant name': 'Plant name', 'Other Name(s)': 'Other Name(s)', 'Unit name': 'Unit name', 'Fuel': 'Fuel', 'Capacity (MW)': 'Capacity (MW)', 'Status': 'Status', 'Turbine/Engine Technology': 'Turbine/Engine Technology', 'Equipment Manufacturer/Model': 'Equipment Manufacturer/Model', 'CHP': 'CHP', 'Hydrogen capable?': 'Hydrogen capable?', 'CCS attachment?': 'CCS attachment?', 'Conversion/replacement?': 'Conversion/replacement?', 'Conversion from/replacement of (fuel)': 'Conversion from/replacement of (fuel)', 'Conversion from/replacement of (GEM unit ID)': 'Conversion from/replacement of (GEM unit ID)', 'Start year': 'Start year', 'Owner(s)': 'Owner(s)', 'Owner(s) GEM Entity ID': 'Owner(s) GEM Entity ID', 'Parent(s)': 'Parent(s)', 'Parent GEM Entity ID': 'Parent GEM Entity ID', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location accuracy': 'Location accuracy', 'City': 'City', 'Major area (prefecture, district)': 'Major area (prefecture, district)', 'State/Province': 'State/Province', 'Subregion': 'Subregion', 'Region': 'Region', 'Other IDs (location)': 'Other IDs (location)', 'Other IDs (unit)': 'Other IDs (unit)', 'GEM location ID': 'GEM location ID', 'GEM unit ID': 'GEM unit ID', 'Fuel classification?': 'Fuel classification?', });
lyr_GlobalNuclearPowerTrackerSeptember2025_giscopy_5.set('fieldAliases', {'Date Last Researched': 'Date Last Researched', 'Country/Area': 'Country/Area', 'Project Name': 'Project Name', 'Unit Name': 'Unit Name', 'Capacity (MW)': 'Capacity (MW)', 'Status': 'Status', 'Reactor Type': 'Reactor Type', 'Model': 'Model', 'Start Year': 'Start Year', 'Commercial Operation Date': 'Commercial Operation Date', 'Owner': 'Owner', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location Accuracy': 'Location Accuracy', 'City': 'City', 'State/Province': 'State/Province', 'Subregion': 'Subregion', 'Region': 'Region', 'GEM location ID': 'GEM location ID', 'GEM unit ID': 'GEM unit ID', 'Wiki URL': 'Wiki URL', });
lyr_GlobalHydropowerTrackerApril2025_gis_slaskiecopy_6.set('fieldAliases', {'Date Last Researched': 'Date Last Researched', 'Country/Area 1': 'Country/Area 1', 'Project Name': 'Project Name', 'Other name(s)': 'Other name(s)', 'Capacity (MW)': 'Capacity (MW)', 'Binational': 'Binational', 'Country/Area 1 Capacity (MW)': 'Country/Area 1 Capacity (MW)', 'Status': 'Status', 'Start Year': 'Start Year', 'Owner': 'Owner', 'Technology Type': 'Technology Type', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location Accuracy': 'Location Accuracy', 'Local Area 1': 'Local Area 1', 'State/Province 1': 'State/Province 1', 'Subregion 1': 'Subregion 1', 'Region 1': 'Region 1', 'GEM location ID': 'GEM location ID', 'GEM unit ID': 'GEM unit ID', 'Wiki URL': 'Wiki URL', });
lyr_GlobalCoalPlantTrackerJanuary2026_gis_slaskiecopy_7.set('fieldAliases', {'GEM unit/phase ID': 'GEM unit/phase ID', 'GEM location ID': 'GEM location ID', 'Country/Area': 'Country/Area', 'Wiki URL': 'Wiki URL', 'Plant name': 'Plant name', 'Unit name': 'Unit name', 'Plant name (other)': 'Plant name (other)', 'Plant name (local)': 'Plant name (local)', 'Owner': 'Owner', 'Owner GEM Entity ID': 'Owner GEM Entity ID', 'Parent': 'Parent', 'Parent GEM Entity ID': 'Parent GEM Entity ID', 'Capacity (MW)': 'Capacity (MW)', 'Status': 'Status', 'Start year': 'Start year', 'Retired year': 'Retired year', 'Planned retirement': 'Planned retirement', 'Coal phaseout year': 'Coal phaseout year', 'Net zero year': 'Net zero year', 'Combustion technology': 'Combustion technology', 'Coal type': 'Coal type', 'Coal source': 'Coal source', 'Conversion to (fuel)': 'Conversion to (fuel)', 'Conversion to (GEM unit ID)': 'Conversion to (GEM unit ID)', 'Alternate Fuel': 'Alternate Fuel', 'Location': 'Location', 'Local area (taluk, county)': 'Local area (taluk, county)', 'Major area (prefecture, district)': 'Major area (prefecture, district)', 'Subnational unit (province, state)': 'Subnational unit (province, state)', 'Subregion': 'Subregion', 'Region': 'Region', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location accuracy': 'Location accuracy', 'Captive': 'Captive', 'Captive industry use': 'Captive industry use', 'CHP': 'CHP', 'Capacity factor': 'Capacity factor', 'Plant age (years)': 'Plant age (years)', 'Heat rate (Btu per kWh)': 'Heat rate (Btu per kWh)', 'Emission factor (kg of CO2 per TJ)': 'Emission factor (kg of CO2 per TJ)', 'Annual CO2 (million tonnes / annum)': 'Annual CO2 (million tonnes / annum)', 'Remaining plant lifetime (years)': 'Remaining plant lifetime (years)', 'Lifetime CO2 (million tonnes)': 'Lifetime CO2 (million tonnes)', });
lyr_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8.set('fieldAliases', {'GEM Mine ID': 'GEM Mine ID', 'Country / Area': 'Country / Area', 'Mine Name': 'Mine Name', 'Mine Name AKAs': 'Mine Name AKAs', 'Mine Name (Non-ENG)': 'Mine Name (Non-ENG)', 'Owners': 'Owners', 'Parent Company': 'Parent Company', 'Company HQs': 'Company HQs', 'Capacity (Mtpa)': 'Capacity (Mtpa)', 'Production (Mtpa)': 'Production (Mtpa)', 'Year of Production': 'Year of Production', 'Mine Type': 'Mine Type', 'Mining Method': 'Mining Method', 'Mine Size (Km2)': 'Mine Size (Km2)', 'Mine Depth (m)': 'Mine Depth (m)', 'Depth Accuracy': 'Depth Accuracy', 'Workforce Size': 'Workforce Size', 'Workforce Accuracy': 'Workforce Accuracy', 'Coal Type': 'Coal Type', 'Coal Grade': 'Coal Grade', 'Opening Year': 'Opening Year', 'Closing Year': 'Closing Year', 'Reason for Closure': 'Reason for Closure', 'Mine Site Status': 'Mine Site Status', 'Coalfield': 'Coalfield', 'Location': 'Location', 'Prefecture, District': 'Prefecture, District', 'State, Province': 'State, Province', 'Subregion': 'Subregion', 'Region': 'Region', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location Accuracy': 'Location Accuracy', 'Reported Coal Mine Methane Emissions (thousand tonnes per year)': 'Reported Coal Mine Methane Emissions (thousand tonnes per year)', });
lyr_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9.set('fieldAliases', {'GEM Mine ID': 'GEM Mine ID', 'Country / Area': 'Country / Area', 'Mine Name': 'Mine Name', 'Mine Name AKAs': 'Mine Name AKAs', 'GEM Wiki Page (ENG)': 'GEM Wiki Page (ENG)', 'Status': 'Status', 'Owners': 'Owners', 'GEM Entity ID': 'GEM Entity ID', 'Owners (Non-ENG)': 'Owners (Non-ENG)', 'Parent Company': 'Parent Company', 'GEM Entity ID_1': 'GEM Entity ID_1', 'Company HQs': 'Company HQs', 'Capacity (Mtpa)': 'Capacity (Mtpa)', 'Production (Mtpa)': 'Production (Mtpa)', 'Year of Production': 'Year of Production', 'Mine Type': 'Mine Type', 'Mining Method': 'Mining Method', 'Mine Size (Km2)': 'Mine Size (Km2)', 'Mine Depth (m)': 'Mine Depth (m)', 'Depth Accuracy': 'Depth Accuracy', 'Workforce Size': 'Workforce Size', 'Workforce Accuracy': 'Workforce Accuracy', 'Coal Type': 'Coal Type', 'Coal Grade': 'Coal Grade', 'Total Reserves (Proven and Probable, Mt)': 'Total Reserves (Proven and Probable, Mt)', 'Year of Total Reserves Recorded': 'Year of Total Reserves Recorded', 'Total Resource (Inferred, Indicated, Measured)': 'Total Resource (Inferred, Indicated, Measured)', 'Reserve to Production Ratio (R/P)': 'Reserve to Production Ratio (R/P)', 'Opening Year': 'Opening Year', 'Closing Year': 'Closing Year', 'Reported Life of Mine': 'Reported Life of Mine', 'Reported Year of Mine Life': 'Reported Year of Mine Life', 'Coalfield': 'Coalfield', 'Location': 'Location', 'State, Province': 'State, Province', 'Subregion': 'Subregion', 'Region': 'Region', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location Accuracy': 'Location Accuracy', 'Reported Coal Mine Methane Emissions (thousand tonnes per year)': 'Reported Coal Mine Methane Emissions (thousand tonnes per year)', 'Year of Reported Coal Mine Methane Emissions': 'Year of Reported Coal Mine Methane Emissions', 'Has associated CMM mitigation data': 'Has associated CMM mitigation data', 'GEM Coal Mine Methane Emissions Estimate (MCM/yr)': 'GEM Coal Mine Methane Emissions Estimate (MCM/yr)', 'GEM Coal Mine Methane Emissions Estimate (M tonnes/yr)': 'GEM Coal Mine Methane Emissions Estimate (M tonnes/yr)', 'Methane Gas Content (m^3/tonne) (Updated)': 'Methane Gas Content (m^3/tonne) (Updated)', 'Methane Emissions Factor (Updated)': 'Methane Emissions Factor (Updated)', 'CMM Emissions (CO2e 20 years)': 'CMM Emissions (CO2e 20 years)', 'CMM Emissions (CO2e 100 years)': 'CMM Emissions (CO2e 100 years)', 'ISO Code': 'ISO Code', });
lyr_GlobalCementandConcreteTracker_July2025_gis_slaskiecopy_10.set('fieldAliases', {'GEM Plant ID': 'GEM Plant ID', 'GEM Asset name (English)': 'GEM Asset name (English)', 'Asset name (other language)': 'Asset name (other language)', 'Alternative asset name(s)': 'Alternative asset name(s)', 'SFI ID': 'SFI ID', 'LeadIT Project ID': 'LeadIT Project ID', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Coordinate accuracy': 'Coordinate accuracy', 'GEM wiki page': 'GEM wiki page', 'Municipality': 'Municipality', 'Subnational unit': 'Subnational unit', 'Country/Area': 'Country/Area', 'Cement Capacity (millions metric tonnes per annum)': 'Cement Capacity (millions metric tonnes per annum)', 'Clinker Capacity (millions metric tonnes per annum)': 'Clinker Capacity (millions metric tonnes per annum)', 'Majority Cement Type': 'Majority Cement Type', 'Cement Color': 'Cement Color', 'Operating status': 'Operating status', 'Start date': 'Start date', 'Owner name (English)': 'Owner name (English)', 'Owner name (other language)': 'Owner name (other language)', 'Owner Entity ID': 'Owner Entity ID', 'Parent': 'Parent', 'Parent Entity ID': 'Parent Entity ID', 'Plant type': 'Plant type', 'Production type': 'Production type', 'CCS/CCUS': 'CCS/CCUS', 'Alternative Fuel': 'Alternative Fuel', 'Clay Calcination': 'Clay Calcination', 'field_30': 'field_30', 'field_31': 'field_31', 'field_32': 'field_32', 'field_33': 'field_33', 'field_34': 'field_34', 'field_35': 'field_35', 'field_36': 'field_36', 'field_37': 'field_37', 'field_38': 'field_38', 'field_39': 'field_39', 'field_40': 'field_40', 'field_41': 'field_41', 'field_42': 'field_42', });
lyr_GlobalBioenergyPowerTrackerGBPTV3_gis_slaskiecopy_11.set('fieldAliases', {'Date last researched': 'Date last researched', 'Country/Area': 'Country/Area', 'Project Name': 'Project Name', 'Unit Name': 'Unit Name', 'Other Name(s)': 'Other Name(s)', 'Capacity (MW)': 'Capacity (MW)', 'Fuel': 'Fuel', 'Status': 'Status', 'Conversion/Replacement?': 'Conversion/Replacement?', 'Unit Conversion Year': 'Unit Conversion Year', 'Start Year': 'Start Year', 'Operator(s)': 'Operator(s)', 'Operator(s) GEM Entity ID': 'Operator(s) GEM Entity ID', 'Owner(s)': 'Owner(s)', 'Owner Name(s) in Local Language / Script': 'Owner Name(s) in Local Language / Script', 'Owner(s) GEM Entity ID': 'Owner(s) GEM Entity ID', 'Parent(s)': 'Parent(s)', 'Parent(s) GEM Entity ID': 'Parent(s) GEM Entity ID', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Location Accuracy': 'Location Accuracy', 'City': 'City', 'Major Area (prefecture, district)': 'Major Area (prefecture, district)', 'State/Province': 'State/Province', 'Subregion': 'Subregion', 'Region': 'Region', 'GEM location ID': 'GEM location ID', 'GEM phase ID': 'GEM phase ID', 'Wiki URL': 'Wiki URL', });
lyr_Grid_12.set('fieldAliases', {'Layer': 'Layer', 'PaperSpace': 'PaperSpace', 'SubClasses': 'SubClasses', 'Linetype': 'Linetype', 'EntityHandle': 'EntityHandle', 'Text': 'Text', });
lyr_GlobalWindPowerTrackerFebruary2026_prep_gis_slaskiecopy_2.set('fieldImages', {'Date Last Researched': 'DateTime', 'Country/Area': 'TextEdit', 'Project Name': 'TextEdit', 'Phase Name': 'Range', 'Capacity (MW)': 'Range', 'Installation Type': 'TextEdit', 'Status': 'TextEdit', 'Start year': 'Range', 'Retired year': 'TextEdit', 'Operator': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Location accuracy': 'TextEdit', 'City': 'TextEdit', 'Local area (taluk, county)': 'TextEdit', 'Major area (prefecture, district)': 'TextEdit', 'State/Province': 'TextEdit', 'Subregion': 'TextEdit', 'Region': 'TextEdit', 'GEM location ID': 'TextEdit', 'GEM phase ID': 'TextEdit', 'Other IDs (location)': 'TextEdit', 'Other IDs (unit/phase)': 'TextEdit', 'Wiki URL': 'TextEdit', });
lyr_GlobalSolarPowerTrackerFebruary2026_gis_slaskie_only_3.set('fieldImages', {'Longitude': 'TextEdit', 'Latitude': 'TextEdit', 'Date Last Researched': 'DateTime', 'Country/Area': 'TextEdit', 'Project Name': 'TextEdit', 'Capacity (MW)': 'TextEdit', 'Capacity Rating': 'TextEdit', 'Technology Type': 'TextEdit', 'Status': 'TextEdit', 'Location accuracy': 'TextEdit', 'City': 'TextEdit', 'Local area (taluk, county)': 'TextEdit', 'State/Province': 'TextEdit', 'Subregion': 'TextEdit', 'Region': 'TextEdit', 'GEM location ID': 'TextEdit', 'GEM phase ID': 'TextEdit', 'Wiki URL': 'TextEdit', });
...
lyr_GlobalCoalMineTrackerMay2025V2_non_operating_gis_slaskie_correct_8.set('fieldLabels', {'GEM Mine ID': 'no label', 'Country / Area': 'no label', 'Mine Name': 'no label', 'Mine Name AKAs': 'no label', 'Mine Name (Non-ENG)': 'no label', 'Owners': 'no label', 'Parent Company': 'no label', 'Company HQs': 'no label', 'Capacity (Mtpa)': 'no label', 'Production (Mtpa)': 'no label', 'Year of Production': 'no label', 'Mine Type': 'no label', 'Mining Method': 'no label', 'Mine Size (Km2)': 'no label', 'Mine Depth (m)': 'no label', 'Depth Accuracy': 'no label', 'Workforce Size': 'no label', 'Workforce Accuracy': 'no label', 'Coal Type': 'no label', 'Coal Grade': 'no label', 'Opening Year': 'no label', 'Closing Year': 'no label', 'Reason for Closure': 'no label', 'Mine Site Status': 'no label', 'Coalfield': 'no label', 'Location': 'no label', 'Prefecture, District': 'no label', 'State, Province': 'no label', 'Subregion': 'no label', 'Region': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Location Accuracy': 'no label', 'Reported Coal Mine Methane Emissions (thousand tonnes per year)': 'no label', });
lyr_GlobalCoalMineTrackerMay2025V2_operating_gis_slaskiecopy_9.set('fieldLabels', {'GEM Mine ID': 'no label', 'Country / Area': 'no label', 'Mine Name': 'no label', 'Mine Name AKAs': 'no label', 'GEM Wiki Page (ENG)': 'no label', 'Status': 'no label', 'Owners': 'no label', 'GEM Entity ID': 'no label', 'Owners (Non-ENG)': 'no label', 'Parent Company': 'no label', 'GEM Entity ID_1': 'no label', 'Company HQs': 'no label', 'Capacity (Mtpa)': 'no label', 'Production (Mtpa)': 'no label', 'Year of Production': 'no label', 'Mine Type': 'no label', 'Mining Method': 'no label', 'Mine Size (Km2)': 'no label', 'Mine Depth (m)': 'no label', 'Depth Accuracy': 'no label', 'Workforce Size': 'no label', 'Workforce Accuracy': 'no label', 'Coal Type': 'no label', 'Coal Grade': 'no label', 'Total Reserves (Proven and Probable, Mt)': 'no label', 'Year of Total Reserves Recorded': 'no label', 'Total Resource (Inferred, Indicated, Measured)': 'no label', 'Reserve to Production Ratio (R/P)': 'no label', 'Opening Year': 'no label', 'Closing Year': 'no label', 'Reported Life of Mine': 'no label', 'Reported Year of Mine Life': 'no label', 'Coalfield': 'no label', 'Location': 'no label', 'State, Province': 'no label', 'Subregion': 'no label', 'Region': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Location Accuracy': 'no label', 'Reported Coal Mine Methane Emissions (thousand tonnes per year)': 'no label', 'Year of Reported Coal Mine Methane Emissions': 'no label', 'Has associated CMM mitigation data': 'no label', 'GEM Coal Mine Methane Emissions Estimate (MCM/yr)': 'no label', 'GEM Coal Mine Methane Emissions Estimate (M tonnes/yr)': 'no label', 'Methane Gas Content (m^3/tonne) (Updated)': 'no label', 'Methane Emissions Factor (Updated)': 'no label', 'CMM Emissions (CO2e 20 years)': 'no label', 'CMM Emissions (CO2e 100 years)': 'no label', 'ISO Code': 'no label', });
